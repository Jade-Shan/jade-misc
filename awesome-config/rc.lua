...
require("lib/widgets/battery/battery")        -- Battery Power Control
--- require("volume")       -- Volume contrl
require("lib/widgets/volume/volume")       -- Volume contrl
...
beautiful.init("/home/jade/.config/awesome/themes/jade/theme.lua")
-- beautiful.init("/home/jade/.config/awesome/themes/matrix/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal   = "x-terminal-emulator"
editor     = "gvim"     --os.getenv("EDITOR") or "editor"
editor_cmd = "vim"      --terminal .. " -e " .. editor
...
--	"blueman-applet",              -- bluetooth manager
  "pidgin",                      -- Pidgin
	...
	"bash /opt/quickstart/synergyc.sh",
